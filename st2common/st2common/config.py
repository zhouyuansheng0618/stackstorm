...
def register_opts(ignore_errors=False):
    rbac_opts = [
        ...
        cfg.StrOpt("adfs", default="https://ifthen-dev.lenovo.com/#/history", help="Default saml_url ."),
    ]
    ...
    auth_opts = [
        ...
        cfg.StrOpt("backend_model", default="", help="Enable authentication middleware."),
        cfg.IntOpt(
