...
class StandaloneAuthHandler(AuthHandlerBase):
    def __init__(self, *args, **kwargs):
        ...
        # self._auth_backend = get_auth_backend_instance(name=cfg.CONF.auth.backend_model)
    ...
    def handle_auth(
        ...
        **kwargs,
        ...
        if cfg.CONF.auth.backend_model == 'rbac':
            if UserDB.objects(name=username,password=password).count() >0:
                result = True
        else:
